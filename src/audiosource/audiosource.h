...
namespace
{
    ...
    QString audioModeToString(AudioTestMode mode)
    {
        ...
        case AudioTestMode::Pull:
            return u"Pull Mode"_s;
        case AudioTestMode::Push:
            return u"Push Mode"_s;
        case AudioTestMode::Callback:
            return u"Callback Mode"_s;
        default:
            return u"Unknown"_s;
        }
    }
...
public:
    AudioInfo(const QAudioFormat &format) : m_format(format) {}
...
public:
    explicit RenderArea(QWidget *parent = nullptr) : QWidget(parent)
    {
...
public:
    InputTest() : m_devices(new QMediaDevices(this))
    {
        init();
    }
    ~InputTest() override
